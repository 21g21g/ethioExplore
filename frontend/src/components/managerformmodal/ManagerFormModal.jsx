        ...
        isOpen && (
            <div className="fixed inset-0 flex items-center justify-center z-50  ">
                <div className="absolute top-1/2 lg:w-1/2  left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg  shadow-lg  lg:px-32 p-8 w-full ">
                    <p className="pb-4 text-center text-3xl mb-3">{userData.role === 'hotelManager' ? 'Please Add Hotel Manager' : 'Please Add The Tour Guide '}</p>
                    <hr className="bg-indigo-700 mb-3" />
